...
li = [];
file_name = '../matlab_timeseries_analysis/results/short_raw_dc_bias.csv'
...
with open('../matlab_timeseries_analysis/results/dc_bias_pdf.csv', 'w') as csvfile:
