...
[A, interval] = plot_parzen(X(:,3), X(:,2)/sum(X(:,2)), gran,'Location 1 PDF','Frequency','Hz');
...
B = plot_parzen(Y(:,3), Y(:,2)/sum(Y(:,2)), gran,'Location 2 PDF','Frequency','Hz');
...
C = plot_parzen(Z(:,3), Z(:,2)/sum(Z(:,2)), gran,'Location 3 PDF','Frequency','Hz');
...
% plot_parzen(X(:,7), X(:,6)/sum(X(:,6)), gran,'Location 1 Magnitude PDF','Magnitude','dBmPa');
...
% plot_parzen(Y(:,7), Y(:,6)/sum(Y(:,6)), gran,'Location 2 Magnitude PDF','Magnitude','dBmPa');
...
% plot_parzen(Z(:,7), Z(:,6)/sum(Z(:,6)), gran,'Location 3 Magnitude PDF','Magnitude','dBmPa');
...
% plot_each_near_zero_pdf(X(:,11), X(:,10)/sum(X(:,10)), gran, 'Location 2 Small DC Bias Contributions', 'Magnitude', 'dBmPa', 0);
% plot_each_nonzero_pdf(X(:,11), X(:,10)/sum(X(:,10)), gran, 'Location 2 Large DC Bias Contributions', 'Magnitude', 'dBmPa', 1);
% 
% plot_parzen(X(:,11), X(:,10)/sum(X(:,10)), gran,'x','Magnitude','dBmPa');
% 
% %location 2
% plot_each_parzen(Y(:,11), Y(:,10)/sum(Y(:,10)), gran, 'Location 2 Aggregate DC Bias Distribution','Magnitude', 'dBmPa');
% plot_each_near_zero_pdf(Y(:,11), Y(:,10)/sum(Y(:,10)), gran, 'Location 2 Small DC Bias Contributions', 'Magnitude', 'dBmPa', 0);
% plot_each_nonzero_pdf(Y(:,11), Y(:,10)/sum(Y(:,10)), gran, 'Location 2 Large DC Bias Contributions', 'Magnitude', 'dBmPa', 1);
% 
% plot_parzen(Y(:,11), Y(:,10)/sum(Y(:,10)), gran,'x','Magnitude','dBmPa');
% 
% %location 3
% plot_each_parzen(Z(:,11), Z(:,10)/sum(Z(:,10)), gran, 'Location 3 Aggregate DC Bias Distribution','Magnitude', 'dBmPa');
% plot_each_near_zero_pdf(Z(:,11), Z(:,10)/sum(Z(:,10)), gran, 'Location 2 Small DC Bias Contributions', 'Magnitude', 'dBmPa', 0);
% plot_each_nonzero_pdf(Z(:,11), Z(:,10)/sum(Z(:,10)), gran, 'Location 2 Large DC Bias Contributions', 'Magnitude', 'dBmPa', 1);
% 
% plot_parzen(Z(:,11), Z(:,10)/sum(Z(:,10)), gran,'x','Magnitude','dBmPa');
