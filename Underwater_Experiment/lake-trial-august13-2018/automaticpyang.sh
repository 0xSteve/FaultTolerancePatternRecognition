...
EXEC="./../experimentCode/raw_to_float_ang.py"
#OUT_DIR=$3
FOLDER=$3
...
for i in `seq 1 $SEND_LOC`; do
   for j in `seq 1 $TRANS_NUM`; do
	   echo "Input file: 
	   $FOLDER""_dat/sendloc$i""_trans$j""_laketrial_aug13_2018_$FOLDER""_ang.dat"
	   echo "Output file:
	   $FOLDER""_ang/sendloc$i""_trans$j""_laketrial_aug13_2018_$FOLDER""_ang.csv"
       $EXEC $FOLDER""_dat/sendloc$i""_trans$j""_laketrial_aug13_2018_$FOLDER""_ang.dat
