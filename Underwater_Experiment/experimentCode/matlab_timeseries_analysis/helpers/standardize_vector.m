function [Y] = standardize_vector(X,Type)
...
%Type=['mean']:Normalizing errors when population parameters are known. Works well for populations that are normal distribution
%Type=['minmaxing'] :Normalizing errors when population parameters are known. Works well for populations that are normal distribution
%Output
