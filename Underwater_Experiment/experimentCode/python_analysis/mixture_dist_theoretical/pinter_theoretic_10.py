...
li = [];
file_name = '../../matlab_timeseries_analysis/theoretic_results/res31x10.csv'
...
with open('../../matlab_timeseries_analysis/theoretic_results/res31x10_sln.csv', 'w') as csvfile:
    muh_writer = csv.writer(csvfile)
